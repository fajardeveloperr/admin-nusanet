<div id="app-sidepanel" class="app-sidepanel">
    ...
    <div class="sidepanel-inner d-flex flex-column">
        ...
        <div class="app-branding">
            <a class="app-logo" href="{{ route('home') }}"><img class="logo-icon me-2" src="{{ asset('vendors/images/nusanett.png') }}" alt="logo"><span class="logo-text">Nusanet</span></a>
        </div><!--//app-branding-->
            ...
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                ...
                <li class="nav-item ">
                    ...
                    <a class="nav-link  active" href="{{ route('home') }}">
                        ...
                        <img src="{{ asset('assets/images/animationn.gif') }}"width="50" alt="">
                         </span>
               ...
               @if (auth()->user()->utype === 'AuthMaster')
                 <li class="nav-item has-submenu">
                    ...
                    <a class="nav-link submenu-toggle" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-2" aria-expanded="false" aria-controls="submenu-1">
                        ...
                        <img src="{{ asset('assets/images/animation_icon.gif') }}"width="50" alt="">
                         </span>
