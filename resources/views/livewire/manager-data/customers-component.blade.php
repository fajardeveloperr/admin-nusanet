                            ...
                            <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                                <div class="col-auto">
                                    <form class="table-search-form row gx-1 align-items-center">
                                        <div class="col-auto">
                                            <input wire:model="search" type="text" id="search-orders" name="searchorders"
                        ...
                        <nav id="orders-table-tab"
                            ...
                            @foreach ($class as $cls)
                                <a class="flex-sm-fill text-sm-center nav-link {{ $cls == 'Personal' ? 'active' : null }}"
                                    ...
                                    aria-controls="orders-{{ $cls }}" aria-selected="true">{{ $cls }}</a>
                            @endforeach
                        </nav>
                    </div>
                    <div class="card-body">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <div class="pd-20 card-box height-20-p">
                                                                                <p class="h4 text-primary text-center mb-5">
                                                                                ...
                                                                                <div class="row border rounded py-2 mx-2 mb-2">
                                                                                    <p class="p-0 m-0 ps-2 fw-bold mb-3">*)
                                                                                        Data
                                                                                        {{ $item == 'Personal' ? 'Status' : 'Penanggung Jawab' }}
                                                                                    </p>
                                                                                    <div class="col-sm-6">
                                                                                        <div class="mb-3 row">
                                                                                            <label for="staticEmail"
                                                                                            ...
                                                                                            <div class="col-sm-6">
                                                                                                <select name="utype" id="utype" class="form-control form-control-sm" >
